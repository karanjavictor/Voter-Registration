        ...
        <v-row>
            ...
            <v-col cols="12" md="4">
                <v-card class="pa-4 rounded-lg" elevation="2">
                    ...
                    <v-card-text>
                        <p class="text-secondary">View your analytics and insights</p>
                    </v-card-text>
                    <v-card-actions>
                        <v-btn color="primary" variant="flat" class="rounded-lg" size="small" to="/dashboard/view-analytics">View Analytics and Insights</v-btn>
                    </v-card-actions>
                </v-card>
            </v-col>
        </v-row>
